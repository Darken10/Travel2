    ...
    >
      <div class="space-y-6 md:space-y-10 mt-10">
        <h1 class="font-bold text-4xl text-center md:hidden">
          T<span class="text-teal-600">.</span>
        </h1>
        <h1 class="hidden md:block font-bold text-sm md:text-xl text-center">
          Travel<span class="text-teal-600">.</span>
        </h1>
        <div id="profile" class="space-y-3">
          <img
            src="{{ asset(Auth::user()->profileUrl) }}"
            alt="Avatar user"
        ...
        <div id="menu" class="flex flex-col space-y-2">
          <a
            ...
            href=""
            class="text-sm font-semibold text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out"
          >
            <svg
          ...
          <a
            ...
            class="text-sm font-semibold text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
          >
            <svg
              class="w-6 h-6 fill-current inline-block"
              fill="currentColor"
