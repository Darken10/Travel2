...
<nav class=" top-0 fixed w-full lg:px-16 px-6 bg-white shadow-md flex flex-wrap items-center lg:py-0 py-2">
      ...
      <nav>
        <ul class="text-xl text-center items-center gap-x-5 pt-4 md:gap-x-4 lg:text-lg lg:flex  lg:pt-0">
          <li class="py-2 lg:py-0 ">
            <a
              class="text-red-600 font-bold no-underline hover:pb-4 hover:border-b-4 hover:border-yellow-400"
              href="#"
            >
              Blog
            </a>
