...
<a href="#">
    <div class=" mt-4 flex bg-white border-l-4 border-blue-600 rounded-lg p-3 shadow-xl mx-4">
        ...
        <span class=" relative w-6 h-6 bg-blue-600 rounded-b-full flex -top-3 border-t-2 border-blue-900  justify-center mx-auto text-gray-100 font-semibold">A</span>
